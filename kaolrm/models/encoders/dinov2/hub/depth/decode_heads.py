...
class FeatureFusionBlock(nn.Module):
    ...
    def __init__(self, in_channels, act_layer, norm_layer, expand=False, align_corners=True):
        ...
        self.res_conv_unit1 = PreActResidualConvUnit(in_channels=self.in_channels, act_layer=act_layer, norm_layer=norm_layer)
        self.res_conv_unit2 = PreActResidualConvUnit(in_channels=self.in_channels, act_layer=act_layer, norm_layer=norm_layer)
...
class DPTHead(DepthBaseDecodeHead):
    ...
    This head is an implemention of `DPT <https://arxiv.org/abs/2103.13413>`_.
    Args:
